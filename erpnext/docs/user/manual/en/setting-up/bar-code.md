...
Revalue and the bar-code mechanism, connect the bar-code machine to your
operating hardware. Then go to Revalue setup and activate bar-code by going to
...
For more ease, activate the POS view in Revalue. The activation process is
