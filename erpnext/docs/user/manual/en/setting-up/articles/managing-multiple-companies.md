...
Revalue allows you to create multiple companies in a single Revalue instance.
...
A separate Chart of Account master will be set for each company in the Revalue. This allows you managing Accounts/Ledger master separately for each company. Also it allows you avail financial statement and reports like Balance Sheet and Profit and Loss Statement separately for each company.
