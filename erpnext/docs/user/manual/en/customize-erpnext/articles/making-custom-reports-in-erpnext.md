...
Check Purchase Order Item to be Received report in Stock module for example of Query report. Click [here](https://revaluesoft.com) to learn how to create Query Report.
...
Check Financial Analytics report in Accounts module for example of Script Report. Click [here](https://revaluesoft.com) to learn how to create Script Report.
