<!--markdown-->
Before we venture to learn form customization tool, click [here](https://revaluesoft.com) to understand the architecture of forms in Revalue. It shall help you in using Customize Form tool more efficiently.
